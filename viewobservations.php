...
<head>
    ...
    include_once 'ObservationUser.php';
    ...
    <div class="bg">
        ...
        ?>
            ...
            <div class="container">
                ...
                <h1>Last 10 Observations</h1>

                <div class="row">
                    <?php
                    
                        $query = "SELECT * FROM `observations` ORDER BY `id` DESC LIMIT 10";
                    ...
                    ?>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="btn btn-light btn-block btn-lg click">
                                <h5><a href="viewallchecks.php?type=observations">See All</a></h5>
                            </div>
                        </div>
                ...
                <?php
                    ...
                    $partnerResults = array();
                        ...
                        while($row = mysqli_fetch_array($result)){
                            ...
                            $thisUser = new ObservationUser($row);
                ...
                ?>
                    ...
                    showCheckStats ('observations','Observations Done', 'Observations Failed', $startDate, $endDate);
