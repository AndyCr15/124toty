    ...
    <div class="bg">
        ...
        ?>
            ...
            <div class="container">
                ...
                <h1>Last 10 Question Checks</h1>

                <div class="row">
                    <?php
                    
                        $query = "SELECT * FROM `questionchecks` ORDER BY `id` DESC LIMIT 10";
                    ...
                    ?>
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="btn btn-light btn-block btn-lg click">
                                <h5><a href="viewallchecks.php?type=questionchecks">See All</a></h5>
                            </div>
                        </div>
                </div>
                ...
                ?>
                    ...
                    <div class="row">
                        ...
                        showCheckStats ('questionchecks','Questions Asked', 'Wrong Answers', $startDate, $endDate);
