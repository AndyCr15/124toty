...
if ($_POST) {
        ...
        $sql = "INSERT INTO `rotationchecks` (partner, type, area, result, discussion, manager) VALUES ('".$partner."','".$type."','".$area."','".$result."','".$discussion."','".$manager."')";
        
        if ($link->query($sql) === TRUE) {
            debug_to_console("New rotation check created successfully");
        } else {
...
if(isset($_GET['remove'])){
    ...
    $sql = "DELETE FROM rotationchecks WHERE id = ".$_GET['remove'];
